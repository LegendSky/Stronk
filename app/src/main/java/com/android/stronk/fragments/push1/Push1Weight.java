...
public class Push1Weight extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            etBenchPress.setText(Double.toString(SharedPrefs.getWeightBenchPress(getContext())));
            etOHPress.setText(Double.toString(SharedPrefs.getWeightOHPress(getContext())));
